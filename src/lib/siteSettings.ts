...
export type HomeSearchSettings = {
  visible: boolean;
  title: string;
  description: string;
  placeholder: string;
...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  homeSearch: {
    ...
    description: "Search by business name, category, or neighborhood from the homepage.",
    placeholder: "Search businesses, food, beauty, services…",
    buttonLabel: "Search directory",
  },
  theme: {
    background: "#F6F0E5",
...
export function sanitizeSettings(input: Partial<SiteSettings> | undefined | null): SiteSettings {
  return ({
    ...
    homeSearch: {
      ...DEFAULT_SITE_SETTINGS.homeSearch,
      ...((input as any)?.homeSearch || {}),
    },
